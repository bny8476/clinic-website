-- Comprehensive Reconcilation of Skipped Migrations (V63, V65, V92)
-- Flyway ignored these migrations on production because of outOfOrder=false and the baselineVersion.
-- This script safely applies them using IF NOT EXISTS to support both clean databases and existing schemas.
...
-- ==========================================
-- Source: V65__add_patient_portal_batch_2.sql
-- ==========================================
