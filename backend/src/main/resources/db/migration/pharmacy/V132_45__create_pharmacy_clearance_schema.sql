...
CREATE TABLE IF NOT EXISTS pharmacy_clearances (
...
CREATE INDEX IF NOT EXISTS idx_pharmacy_clearances_patient ON pharmacy_clearances(patient_id);
CREATE INDEX IF NOT EXISTS idx_pharmacy_clearances_status ON pharmacy_clearances(status);
