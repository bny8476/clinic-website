CREATE TABLE IF NOT EXISTS pharmacy_ward_replacement_returns (
...
CREATE TABLE IF NOT EXISTS pharmacy_ward_replacement_return_items (
    id BIGINT NOT NULL GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
CREATE INDEX IF NOT EXISTS idx_ward_repl_ret_status ON pharmacy_ward_replacement_returns(status);
